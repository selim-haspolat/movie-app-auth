...
const Login = () => {
  ...
  return (
    <div className="w-full h-screen absolute top-0 left-0 p-4 flex justify-center items-center overflow-hidden">
      <main className="w-full md:w-5/6 xl:w-4/6 h-9/10 flex items-center bg-gray-100 rounded-lg font-mono">
        <div className="w-full sm:w-1/2 md:w-1/3 p-10 grid grid-cols-1 space-y-4">
          <span className="font-bold text-2xl">Access your account</span>
          <form onSubmit={loginUser} className="space-y-2">
            <input
              onChange={(e) =>
                setLoginData({ ...loginData, email: e.target.value })
              }
              className="w-full rounded-md px-2 py-1 focus:outline outline-1 outline-gray-400"
              type="email"
              placeholder="Email"
              required
            />
            <input
              ...
              required
            />
            <button type="submit" className="w-full focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-purple-500 hover:bg-purple-600 hover:shadow-lg">
              Login
            </button>
          </form>
          <Link to="/register" className="flex justify-center gap-3">
            <svg
        ...
        <div className="hidden sm:inline sm:w-1/2 md:w-2/3 p-10 md:p-20">
          ...
          >
            ...
            <circle cx="252.0149" cy="349.21276" r="3.57649" fill="#8b5cf6" />
            <polygon
            ...
            <polygon
              ...
              fill="#e6e6e6"
            />
            <circle cx="455.33966" cy="188.55082" r="3.57649" fill="#8b5cf6" />
            <polygon
            ...
            <rect
              ...
              fill="#8b5cf6"
            />
            <circle cx="606.5" cy="114.5" r={11} fill="#8b5cf6" />
          </svg>
        </div>
      </main>
    </div>
